...
![GTKWave Waveform Example](WEEK_1/assets/GTKWAVE_WAVEFORM.png)

4. BOTH WAVEFORMS SHOULD BE SAME: RTL AND NETLIST

![Synthesis Flow](WEEK_1/assets/Lecture_Notes/flow.png)
...
![Synthesis Illustration](WEEK_1/assets/Lecture_Notes/synthesis_illustration.png)
...
![Library Path](WEEK_1/assets/lib_path.png)
![Library Content](WEEK_1/assets/lib_content.png)
...
![Multiple Modules Hierarchical](WEEK_1/assets/multiple_modules.png)
...
![Multiple Modules Flat](WEEK_1/assets/multiple_modules_flatten.png)
...
![Multiple Modules Sub-module](WEEK_1/assets/multiple_modules_sub_module1.png)
...
![DFF Async Res Sync Res Waveform](WEEK_1/assets/waveform_dff_asyncres_syncres.png)
...
![DFF Async Res Sync Res](WEEK_1/assets/dff_asyncres_syncres.png)
...
![opt_check](WEEK_1/assets/opt_check.png)
![multiple_modules_opt](WEEK_1/assets/multiple_modules_opt.png)
...
![dff_const1](WEEK_1/assets/waveform_dff_const1.png)
![dff_const2](WEEK_1/assets/waveform_dff_const2.png)
![dff_const3](WEEK_1/assets/waveform_dff_const3.png)
![dff_const4](WEEK_1/assets/waveform_dff_const4.png)
![dff_const5](WEEK_1/assets/waveform_dff_const5.png)
...
![dff_const1](WEEK_1/assets/dff_const1.png)
![dff_const2](WEEK_1/assets/dff_const2.png)
![dff_const3](WEEK_1/assets/dff_const3.png)
![dff_const4](WEEK_1/assets/dff_const4.png)
![dff_const5](WEEK_1/assets/dff_const5.png)
...
![counter_opt](WEEK_1/assets/counter_opt.png)
![counter_opt_waveform](WEEK_1/assets/waveform_counter_opt.png)

counter_opt2:
> assign q = (count[2:0] == 3'b100);

![counter_opt2](WEEK_1/assets/counter_opt2.png)

### [Verify Outputs](WEEK_1/assets/)
### [Generated Netlists](WEEK_1/assets/FILES)
### [Lecture Notes](WEEK_1/assets/Lecture_Notes/)
...
![ternary_operator_mux_waveform](WEEK_1/assets/waveform_ternary_operator_mux.png)
![bad_mux_waveform](WEEK_1/assets/waveform_bad_mux.png)
![good_mux_waveform](WEEK_1/assets/waveform_good_mux.png)
![blocking_caveat_waveform](WEEK_1/assets/waveform_blocking_caveat.png)
...
![ternary_operator_mux](WEEK_1/assets/ternary_operator_mux.png)
![bad_mux](WEEK_1/assets/bad_mux.png)
![good_mux](WEEK_1/assets/good_mux.png)
![blocking_caveat](WEEK_1/assets/blocking_caveat.png)
...
![gls_ternary](WEEK_1/assets/gls_waveform_ternary_operator_mux.png)
![gls_bad](WEEK_1/assets/gls_waveform_bad_mux.png)
![gls_good](WEEK_1/assets/gls_waveform_good_mux.png)
![gls_caveat](WEEK_1/assets/gls_waveform_blocking_caveat.png)

### Synthesis Simulation Mismatch

![rtl_bad](WEEK_1/assets/waveform_bad_mux.png)
![gls_bad](WEEK_1/assets/gls_waveform_bad_mux.png)
...
1. **Mux Generate**
   ...
   ![mux_generate_waveform_2](WEEK_1/assets/waveform_mux_generate_2.png)
   ![mux_generated_waveform](WEEK_1/assets/waveform_mux_generated.png)
   ![mux_generate](WEEK_1/assets/mux_generate.png)

2. **Demux Case**

   ![demux_case_waveform](WEEK_1/assets/waveform_demux_case.png)
   ![demux_case](WEEK_1/assets/demux_case.png)

3. **Demux Generate**

   ![demux_generate_waveform](WEEK_1/assets/waveform_demux_generate.png)
   ![demux_generate](WEEK_1/assets/demux_generate.png)

4. **Ripple Carry Adder using Full Adder**

   ![rca_waveform](WEEK_1/assets/waveform_rca.png)
   ![rca_waveform_2](WEEK_1/assets/waveform_rca_2.png)
   ![rca_waveform_3](WEEK_1/assets/waveform_rca_3_mid.png)
   ![rca_waveform_4](WEEK_1/assets/waveform_rca_4.png)
   ![rca_waveform_5](WEEK_1/assets/waveform_rca_5_end.png)
   ![fa](WEEK_1/assets/fa.png)
   ![rca](WEEK_1/assets/rca.png)
