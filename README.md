...
# Week 2: Pre-Synthesis & Post-Synthesis Verification of BabySoC (Fundamentals & Functional Modelling)
...
* **Also Check Out:** [VSDBabySoC](WEEK_2/VSDBabySoC/README.md) for a simpler implementation to started with.
...
#### Simulation Logs
Simulation logs are available in `logs/synthesis.log` and other log files in the [WEEK_2/logs](WEEK_2/logs) directory.

#### GTKWave Screenshots and Explanations

![Pre-Synthesis Waveform](WEEK_2/assets/waveform_Pre_Synthesis.png)
...
![Post-Synthesis Waveform](WEEK_2/assets/waveform_Post_Synthesis.png)
...
![Comparison Pre vs Post Synthesis](WEEK_2/assets/Comparison_Pre_vs_Post_Synthesis.png)
...
![Successful RTL Simulation Waveform](WEEK_2/assets/waveform_Pre_Synthesis.png)
...
![Synthesized soc](WEEK_2/assets/soc.yosys_show.png)
...
![chip_area](WEEK_2/assets/chip_area.png)
...
```
[Check](WEEK_2/logs/synthesis.log): the full synthesis report for more details.

![Yosys Synthesis Report Summary](WEEK_2/assets/Comparison_1_Pre_vs_Post_Synthesis.png)
...
![Instruction Fetches](WEEK_2/assets/waveform_Post_Synthesis.png)
...
![Looping](WEEK_2/assets/waveform_Post_Synthesis.png)
...
![Comparison of RTL vs. GLS Waveforms](WEEK_2/assets/Comparison_Pre_vs_Post_Synthesis.png)
